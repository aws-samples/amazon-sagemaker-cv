...
from sagemakercv.core import anchors, preprocess_ops
from .coco_utils import POLYGON_PAD_VALUE
...
def prepare_labels_for_eval(
    ...
    # TODO: This needs to be updated for new mask format
    '''if use_instance_mask:
...
def process_targets_for_training(padded_image_size, boxes, classes, params):
    input_anchors = anchors.AnchorGenerator(
        params['min_level'],
        params['max_level'],
        params['num_scales'],
