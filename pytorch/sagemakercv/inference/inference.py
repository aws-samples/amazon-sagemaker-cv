...
from sagemakercv.data.datasets.evaluation import evaluate
from sagemakercv.data import datasets
from sagemakercv.utils.comm import is_main_process, all_gather, synchronize
