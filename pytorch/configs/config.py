...
_C.INPUT = CN()
# Dataloader type
_C.INPUT.DATALOADER = 'COCO'
# Train input dir
_C.INPUT.TRAIN_INPUT_DIR = '/opt/ml/input/data/coco/train'
# Validation input dir
_C.INPUT.VAL_INPUT_DIR = '/opt/ml/input/data/coco/val'
# Train annotations
_C.INPUT.TRAIN_ANNO_DIR = '/opt/ml/input/data/coco/annotations/instances_train2017.json'
# Validation annotations
_C.INPUT.VAL_ANNO_DIR = '/opt/ml/input/data/coco/annotations/instances_val2017.json'
...
# ---------------------------------------------------------------------------- #
# CASCADE ROI HEADS options
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_HEADS.CASCADE = CN()
_C.MODEL.ROI_HEADS.CASCADE.FG_IOU_THRESHOLD = (0.5, 0.6, 0.7)
_C.MODEL.ROI_HEADS.CASCADE.BG_IOU_THRESHOLD = (0.5, 0.6, 0.7)
_C.MODEL.ROI_HEADS.CASCADE.BBOX_REG_WEIGHTS = ((10., 10., 5., 5.), (20., 20., 10., 10.), (30., 30., 15., 15.))
_C.MODEL.ROI_HEADS.CASCADE.STAGES = 3
_C.MODEL.ROI_HEADS.CASCADE.STAGE_WEIGHTS = (1., 1., 1.)

# ---------------------------------------------------------------------------- #
# BOX ROI HEADS options
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_BOX_HEAD = CN()
_C.MODEL.ROI_BOX_HEAD.TYPE = "StandardBoxHead"
